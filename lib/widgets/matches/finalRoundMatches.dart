...
class FinalRoundMatchScheduleWidget extends StatefulWidget {
  final String tournamentId;
  FinalRoundMatchScheduleWidget({required this.tournamentId});
  @override
  _FinalRoundMatchScheduleWidgetState createState() =>
      _FinalRoundMatchScheduleWidgetState();
}

class _FinalRoundMatchScheduleWidgetState
    extends State<FinalRoundMatchScheduleWidget> {
  ...
  Future<void> organizeAutomaticMatches(List<String> teamIds) async {
    ...
    String team1 = teamIds[0];
    String team2 = teamIds[1];
  ...
  void showUpdateMatchDialog(
    ...
    showDialog(
        context: context,
        builder: (context) => FinalMatchUpdaterDialog(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Center(
                                  child: Text('$matchDate/$matchTime',
                                      style: TextStyle(
                                          fontFamily: 'karla',
                                          color: Colors.white))),
                            ),
...
class FinalMatchUpdaterDialog extends StatefulWidget {
  final String tournamentId;
  ...
  @override
  _FinalMatchUpdaterDialogState createState() =>
      _FinalMatchUpdaterDialogState();
}

class _FinalMatchUpdaterDialogState extends State<FinalMatchUpdaterDialog> {
...
//   Future<void> organizeAutomaticMatches(List<String> teamIds) async {
//     if (teamIds.length != 2) return; // Safety check
